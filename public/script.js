...
import { collection, doc, getDoc } from "https://www.gstatic.com/firebasejs/9.22.2/firebase-firestore.js";
...
// Přihlašovací logika s Firestore
...
loginForm.onsubmit = async function(e) {
    ...
    // Ověření uživatele z Firestore (kolekce "users", dokument s ID = loginId)
    ...
    if (userSnap.exists()) {
        ...
        errorDiv.textContent = 'Uživatel neexistuje!';
    }
};
